...
function Player1Page() {
  ...
  const handleStoreDate = async () => {
    ...
    try {
      ...
      const contractAddress = '0x5Fc077BE16D41141b464cdbFB16b9E4BBeCee6Fa'
      ...
      <div className="cards-container" style={{justifyContent: 'center'}}>
        <div className="card" style={{maxWidth: '500px'}}>
          ...
          <div style={{
            ...
            <div style={{fontSize: '0.85rem', color: '#6c757d', wordBreak: 'break-all'}}>📍 Contract: 0x5Fc077BE16D41141b464cdbFB16b9E4BBeCee6Fa</div>
          </div>
