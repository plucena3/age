...
function Player1Page() {
  ...
  const handleStoreDate = async () => {
    ...
    try {
      ...
      const contractAddress = '0x9375832c710ac129B7e9C07c86484509c1FD3E9D'
      ...
      <div className="cards-container" style={{justifyContent: 'center'}}>
        <div className="card" style={{maxWidth: '500px'}}>
          ...
          <div style={{
            ...
            <div style={{fontSize: '0.85rem', color: '#6c757d', wordBreak: 'break-all'}}>📍 Contract: 0x9375832c710ac129B7e9C07c86484509c1FD3E9D</div>
          </div>
